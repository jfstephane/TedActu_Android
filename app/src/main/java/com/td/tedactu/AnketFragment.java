...
import com.td.tedactu.Api.AnketRetrofitArrayApi;
import com.td.tedactu.Api.SocieteRetrofitArrayApi;
...
public class AnketFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        View view =  inflater.inflate(R.layout.fragment_anket, parent, false);


        recyclerView = view.findViewById(R.id.rvanket);
        progressBar = view.findViewById(R.id.pbanket);
    ...
    private void getRetrofit()
    {
        ...
        AnketRetrofitArrayApi service = retrofit.create(AnketRetrofitArrayApi.class);
