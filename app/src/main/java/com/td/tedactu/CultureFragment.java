...
import com.td.tedactu.Api.CultureRetrofitArrayApi;
...
public class CultureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        View view =  inflater.inflate(R.layout.fragment_culture, parent, false);
    ...
    private void getRetrofit()
    {
        ...
        CultureRetrofitArrayApi service = retrofit.create(CultureRetrofitArrayApi.class);
