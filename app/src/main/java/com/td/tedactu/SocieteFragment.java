...
public class SocieteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_societe, parent, false);


        recyclerView = view.findViewById(R.id.rvsociete);
        progressBar = view.findViewById(R.id.pbsociete);
    ...
    private void getRetrofit()
    {
        ...
        SocieteRetrofitArrayApi service = retrofit.create(SocieteRetrofitArrayApi.class);
