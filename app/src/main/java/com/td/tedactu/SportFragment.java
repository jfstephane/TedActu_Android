...
import com.td.tedactu.Api.SportRetrofitArrayApi;
...
public class SportFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        progressBar = view.findViewById(R.id.pbsport);
    ...
    private void getRetrofit()
    {
        ...
        SportRetrofitArrayApi service = retrofit.create(SportRetrofitArrayApi.class);
